...
import com.mxixm.fastboot.weixin.module.pay.WxPay;
import com.mxixm.fastboot.weixin.module.pay.WxPayQuery;
...
import com.mxixm.fastboot.weixin.service.invoker.annotation.WxApiBody.Scene;
import com.mxixm.fastboot.weixin.service.invoker.annotation.WxApiBody.Type;
...
public interface WxApiService {
    ...
    WxPay.WxOrderResult unifiedOrder(@WxApiBody(type=Type.XML ,scene=Scene.Pay ) WxPay.WxOrder order);
    WxPayQuery.WxOrderQueryResult orderQuery(@WxApiBody(type=Type.XML ,scene=Scene.Pay ) WxPayQuery.WxOrderQuery query);
}
